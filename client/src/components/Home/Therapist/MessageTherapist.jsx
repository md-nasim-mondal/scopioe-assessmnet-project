        ...
        <div className='flex justify-between md:items-center relative gap-8 flex-col lg:flex-row'>
          <div className='space-y-6'>
            ...
            <div className='hidden lg:block'>
              <form className='bg-[#EEF2F5] dark:bg-white rounded-lg p-1.5 flex'>
                <input
                  type='text'
                  name='searchField'
                  id='searchField'
                  placeholder='ZIP code or city name'
                  className='border-none bg-[#EEF2F5] dark:bg-white flex-1 rounded-l-md'
                />
                <button
                  type='submit'
          ...
          <div className='absolute lg:right-[5%] z-10 bottom-[25%] lg:bottom-0'>
